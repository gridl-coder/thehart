...
// Use this file to wire up interactive components or fetch dynamic content.
...
if ($("#singleMap").length > 0) {
    var latlog = $('#singleMap').data('latlog'),
        popupTextit = $('#singleMap').data('popuptext'),
        map = L.map('singleMap').setView(latlog, 15);
...
console.info('White Hart wireframe ready.');
